...
- $K_{evap} = \frac{d_{w_{evap}}^{2}\epsilon_{evap}^{3}}{122(1-\epsilon_{evap}^{2})}$ (Evaporator Permeability, $m^{2}$) uses the Kozeny-Carman equation. [Davoud Jafari, Wessel W. Wits, Bernard J. Geurts, Metal 3D-printed wick structures for heat pipe application: Capillary performance analysis, Applied Thermal Engineering, Volume 143,2018,
Pages 403-414,](https://www.sciencedirect.com/science/article/pii/S1359431118322981)
